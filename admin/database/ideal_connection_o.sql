...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2018 at 08:32 AM
...
(6, 'denise', '123456789', 'denisexue13@gmail.com', 'd1234568k', 0, 3, 3, '2017-12-27', '04:00 PM', '05:00 PM', 0, '', '', 2, 0, '2017-12-15 16:20:35', 10000, '2018-03-01 14:14:24'),
...
CREATE TABLE `db_booking` (
  ...
  `book_name` varchar(200) NOT NULL COMMENT '"BOOKING NAME"',
  `book_telephone` varchar(10) NOT NULL,
  `book_email` varchar(200) NOT NULL,
  `book_nric` varchar(15) NOT NULL,
  `book_total_person` int(11) NOT NULL,
  `book_service_type` int(11) NOT NULL,
  `book_location` int(11) NOT NULL,
  `book_date` date NOT NULL,
  `book_time` text NOT NULL,
  `book_end_time` text NOT NULL,
  `book_incharge_person` int(11) NOT NULL,
  `book_address` text NOT NULL,
  `book_remarks` text NOT NULL,
  `book_confirm` int(11) NOT NULL,
  `book_date_a` date NOT NULL,
  `book_remarks_a` text NOT NULL,
  `book_salesperson` int(11) NOT NULL,
  `insertBy` int(11) NOT NULL,
  `insertDateTime` datetime NOT NULL,
  `updateBy` int(11) NOT NULL,
  `updateDateTime` datetime NOT NULL
...
INSERT INTO `db_booking` (`book_id`, `book_name`, `book_telephone`, `book_email`, `book_nric`, `book_total_person`, `book_service_type`, `book_location`, `book_date`, `book_time`, `book_end_time`, `book_incharge_person`, `book_address`, `book_remarks`, `book_confirm`, `book_date_a`, `book_remarks_a`, `book_salesperson`, `insertBy`, `insertDateTime`, `updateBy`, `updateDateTime`) VALUES
(1, '111', '111', 'eumerjoseph.ramos@yahoo.com', '3242', 0, 3, 1, '2018-03-13', '01:00 PM', '02:00 PM', 0, 'awwwwwwwww', 'awwwwwwwwwww', 1, '0000-00-00', '', 1, 10000, '2018-03-01 13:11:20', 10000, '2018-03-01 15:07:04'),
(2, 'ase', 'a', 'eumerjoseph.ramos@yahoo.com', '12131', 0, 3, 1, '2018-03-29', '02:30 PM', '03:30 PM', 0, 'asdad', 'adsad', 1, '0000-00-00', '', 1, 10000, '2018-03-01 14:42:18', 10000, '2018-03-01 15:07:04');
...
CREATE TABLE `db_discount` (
  ...
  `disc_code` varchar(75) NOT NULL,
  `disc_valid_from` date NOT NULL,
  `disc_valid_to` date NOT NULL,
  `disc_percent` decimal(7,2) NOT NULL,
...
INSERT INTO `db_discount` (`disc_id`, `disc_code`, `disc_valid_from`, `disc_valid_to`, `disc_percent`, `disc_amount`, `insertBy`, `insertDateTime`, `updateBy`, `updateDateTime`) VALUES
(9, '11ad34', '2018-02-21', '2018-02-27', '0.35', '1111.00', 10000, '2018-02-28 16:41:03', 10000, '2018-02-28 16:41:34');
...
INSERT INTO `db_location` (`location_id`, `location_title`, `location_postal_code`, `location_unit_no`, `location_address`, `location_desc`, `location_type`, `location_close`, `location_status`, `insertBy`, `insertDateTime`, `updateBy`, `updateDateTime`) VALUES
(1, 'test', 1234, '', '440C CLEMENTI AVENUE 3 CLEMENTI CASCADIA SINGAPORE 123440', 'asdrrkkkk', 3, '', 1, 10000, '2018-02-28 17:22:55', 10000, '2018-03-01 11:37:46');

-- --------------------------------------------------------

--
-- Table structure for table `db_loctype`
--

CREATE TABLE `db_loctype` (
  `loctype_id` int(11) NOT NULL,
  `loctype_type` varchar(75) NOT NULL COMMENT '"LOCATION TYPE"',
  `loctype_desc` text NOT NULL COMMENT '"DESCRIPTION"',
  `loctype_status` int(4) NOT NULL COMMENT '"STATUS"',
  `insertBy` int(11) NOT NULL,
  `insertDateTime` datetime NOT NULL,
  `updateBy` int(11) NOT NULL,
  `updateDateTime` datetime NOT NULL
...
--
-- Dumping data for table `db_loctype`
--

INSERT INTO `db_loctype` (`loctype_id`, `loctype_type`, `loctype_desc`, `loctype_status`, `insertBy`, `insertDateTime`, `updateBy`, `updateDateTime`) VALUES
(1, 'Bus Interchange', 'Bus Interchange', 1, 10000, '2018-02-28 14:05:24', 10000, '2018-02-28 14:05:24'),
(2, 'MRT Station', 'MRT Station', 1, 10000, '2018-02-28 14:05:34', 10000, '2018-02-28 14:05:34'),
(3, 'Raffles I Tanjong Pagar Exchange', 'Raffles I Tanjong Pagar Exchange', 1, 10000, '2018-02-28 14:05:43', 10000, '2018-02-28 14:05:43'),
(4, 'Others', 'Others', 1, 10000, '2018-02-28 14:05:52', 10000, '2018-02-28 14:05:52');
...
(10, '', 'fa fa-map-marker', 'Location Type', 'location_type.php', 0, 3, 0, 30, 1, 1000, '2018-02-28 00:00:00', 1000, '2018-02-28 00:00:00'),
(11, '', 'fa fa-percent', 'Discount', 'discount.php', 0, 3, 0, 40, 1, 1000, '2018-02-28 00:00:00', 1000, '2018-02-28 00:00:00');
...
--
-- Indexes for table `db_loctype`
--
ALTER TABLE `db_loctype`
  ADD PRIMARY KEY (`loctype_id`);
...
--
ALTER TABLE `db_discount`
  MODIFY `disc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
-- AUTO_INCREMENT for table `db_loctype`
--
ALTER TABLE `db_loctype`
  MODIFY `loctype_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
