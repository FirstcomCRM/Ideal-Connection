          ...
          <section class="content">
            <div class="box box-info">
              <div class="box-header with-border">
                ...
                <button type = "button" class="btn btn-info pull-right radius_button" style = '' onclick = "window.location.href='empl.php'">Search</button>
                <?php if(getWindowPermission($_SESSION['m'][$_SESSION['empl_id']],'create')){?>
                <button type = "button" class="btn btn-info pull-right radius_button" style = 'margin-right:10px;' onclick = "window.location.href='empl.php?action=createForm'"> + New User</button>
                <?php }?>
              </div>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-info">
                ...
                <?php if(getWindowPermission($_SESSION['m'][$_SESSION['empl_id']],'create')){?>
                <button class="btn btn-info pull-right radius_button" onclick = "window.location.href='empl.php?action=createForm'"> + New User </button>
                <?php }?>
                </div><!-- /.box-header -->
                    ...
                    ?>
                        <tr>
                            ...
                            <td class = "text-align-right">
                                ...
                                if(getWindowPermission($_SESSION['m'][$_SESSION['empl_id']],'update')){
                                ?>
                                <button type="button" class="btn btn-primary btn-info small_radius_button" onclick = "location.href = 'empl.php?action=edit&empl_id=<?php echo $row['empl_id'];?>'">Edit</button>
                                <?php }?>
                                <?php 
                                if(getWindowPermission($_SESSION['m'][$_SESSION['empl_id']],'delete')){
                                ?>
                                <button type="button" class="btn btn-primary btn-danger small_radius_button" onclick = "confirmAlertHref('empl.php?action=delete&empl_id=<?php echo $row['empl_id'];?>','Confirm Delete?')">Delete</button>
                                <?php }?>
                            </td>
                        </tr>
                    <?php    
